public class Laura extends Personagem {

    public Laura(char PosicaoInicial){
        ...
        setTechniques(3);
        setRange(1);
        setDescription("Just Gotta Dance");
    ...
    public Object[] AtaquesEspeciais(int Especial){
        ...
        switch (Especial){
            case  1 :
                System.out.println(getName()+"  Seoi Throw ");
                Lista_Parametros[2] = (getRange()* 4 );
                Lista_Parametros[3] = (getDamage()* 6 );
                break;
            case  2 :
                System.out.println(getName()+"  Pullback Hold ");
                Lista_Parametros[2] = (getRange()* 16 );
                Lista_Parametros[3] = (getDamage()* 10 );
                break;
            case  3 :
                System.out.println(getName()+"  Volty Line  ");
                Lista_Parametros[2] = (getRange()* 7 );
                Lista_Parametros[3] = (getDamage()* 8 );
                break;
            case  4 :
                System.out.println(getName()+"  Linear Movement - Avante  ");
                Lista_Parametros[2] = (getRange()* 21 );
                Lista_Parametros[3] = (getDamage()* 6 );
                break;
            case  5 :
                System.out.println(getName()+"  Linear Movement - Esquiva  ");
                Lista_Parametros[2] = (getRange()* 9 );
                Lista_Parametros[3] = (getDamage()* 6 );
                break;
            case  6 :
                System.out.println(getName()+"  Linear Movement - Finta  ");
                Lista_Parametros[2] = (getRange()* 18 );
                Lista_Parametros[3] = (getDamage()* 9 );
                break;
            case  7 :
                System.out.println(getName()+"  Spark Show  ");
                Lista_Parametros[2] = (getRange()* 22 );
                Lista_Parametros[3] = (getDamage()* 11 );
                break;
            case  8 :
                System.out.println(getName()+"  Shock Stance  ");
                Lista_Parametros[2] = (getRange()* 28 );
                Lista_Parametros[3] = (getDamage()* 5 );
                break;
            case  9 :
                System.out.println(getName()+"  Double Slap  ");
                Lista_Parametros[2] = (getRange()* 22 );
                Lista_Parametros[3] = (getDamage()* 3 );
                break;
            case  10 :
                System.out.println(getName()+"  Step Elbow ");
                Lista_Parametros[2] = (getRange()* 23 );
                Lista_Parametros[3] = (getDamage()* 8 );
                break;
            case  11 :
                System.out.println(getName()+"  Twist Barrage ");
                Lista_Parametros[2] = (getRange()* 17 );
                Lista_Parametros[3] = (getDamage()* 9 );
                break;
            case  12 :
                System.out.println(getName()+"  Dual Crash ");
                Lista_Parametros[2] = (getRange()* 27 );
                Lista_Parametros[3] = (getDamage()* 2 );
                break;
            case  13 :
                System.out.println(getName()+"  Bolt Charge  ");
                Lista_Parametros[2] = (getRange()* 14 );
                Lista_Parametros[3] = (getDamage()* 3 );
                break;
            case  14 :
                System.out.println(getName()+"  Split River  ");
                Lista_Parametros[2] = (getRange()* 9 );
                Lista_Parametros[3] = (getDamage()* 3 );
                break;
            case  15 :
                System.out.println(getName()+"  Rodeo Break  ");
                Lista_Parametros[2] = (getRange()* 11 );
                Lista_Parametros[3] = (getDamage()* 4 );
                break;
            case  16 :
                System.out.println(getName()+"  Thunder Clap  ");
                Lista_Parametros[2] = (getRange()* 13 );
                Lista_Parametros[3] = (getDamage()* 9 );
                break;
            case  17 :
                System.out.println(getName()+"  Sunset Wheel  ");
                Lista_Parametros[2] = (getRange()* 7 );
                Lista_Parametros[3] = (getDamage()* 3 );
                break;
            case  18 :
                System.out.println(getName()+"  Matsuda Sway ");
                Lista_Parametros[2] = (getRange()* 20 );
                Lista_Parametros[3] = (getDamage()* 10 );
                break;
            case  19 :
                System.out.println(getName()+"  Shock Choke ");
                Lista_Parametros[2] = (getRange()* 25 );
                Lista_Parametros[3] = (getDamage()* 3 );
                break;
            case  20 :
                System.out.println(getName()+"  Inazuma Spin Hold  ");
